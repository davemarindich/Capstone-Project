						...
						<aside class="left-sidebar">
							<div class="widget">
								...
								<ul class="cat">
									...
									<li><i class="icon-angle-right"></i> <a href="contact">Contact
											Us</a> <i class="icon-envelope"></i></li>
									<li><i class="icon-angle-right"></i> <a href="about">About</a>
										<i class="icon-cog"></i></li>
									<li><i class="icon-angle-right"></i> <a href="services">Services</a>
										<i class="icon-wrench"></i></li>
									<li><i class="icon-angle-right"></i> <a href="login">
											Login</a> <i class="icon-unlock"></i></li>
								</ul>
							</div>
						</aside>
					</div>
											...
											<tbody>
												...
												<c:forEach var="pi" items="${list}">
													...
													<tr>
														<td>${count}.</td>
														<td><img
															src="static/img/products/${pi.refid}/${pi.img}"
															alt="Cart Item"
															style="width: 150px; height: 145px; border-radius: 50%;">
															${pi.name}</td>
														<td>${pi.price}</td>
														<td>${pi.color} ${pi.type}</td>
														<td><a href="remove?id=${pi.id}">Remove</a></td>
