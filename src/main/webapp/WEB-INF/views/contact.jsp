...
<body>
  ...
  <div id="wrapper">
    ...
    <section id="content">
          ...
          <div class="span8">
            ...
            <form action="sendemail" method="post" role="form" class="contactForm">
              <div class="row">
                ...
                <div class="span8 form-group">
                  <textarea id="msg" name="message" rows="5" data-rule="required" data-msg="Please write something for us"
                    placeholder="Message"></textarea>
                  <div class="validation"></div>
                  <div class="text-center">
                    <button class="btn btn-theme btn-medium margintop10" id="send" type="submit">Send a message</button>
                  </div>
                </div>
              </div>
            </form>
            ...
            <aside class="right-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="contact-info">
                  <li><label>Address :</label> Fresh Farms company Inc.<br /> Lake Charles,La 70607</li>
                  <li><label>Phone :</label>(123) 456-7890</li>
                  <li><label>Fax : </label>+62 123 456 10 / +62 123 456 11</li>
                  <li><label>Email : </label> info@freshfarms.com</li>
                </ul>
      ...
      1m12!1m3!1d22864.11283411948!2d-73.96468908098944!3d40.
      630720240038435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1
      !3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew+
      York%2C+NY%2C+USA!5e0!3m2!1sen!2sbg!4v1540447494452" 
